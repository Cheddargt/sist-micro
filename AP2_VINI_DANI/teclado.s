...
; -------------------------------------------------------------------------------
; Função Verifica Tecla
; Parâmetro de entrada: Nenhum
; Parâmetro de saída:   R0 --> Número que foi precionado ou 10 se nenhuma tecla foi precionada
...
; -------------------------------------------------------------------------------
; Função Verifica Tecla
; Parâmetro de entrada: R1 --> Bit a ser verificado
; Parâmetro de saída:   R0 --> 1 se a tecla foi precionada, 0 do contrario
; Modifica: R0, R1, R2, R3
VerificaTecla
    PUSH {LR}
    MOV R3, R0
