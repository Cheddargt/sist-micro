...
;			
			...
			LDR     R0, =SYSCTL_PRTIMER_R			;Carrega o endereço do PRGPIO para esperar os GPIO ficarem prontos
EsperaTIMER LDR     R1, [R0]						;Lê da memória o conteúdo do endereço do registrador
			MOV     R2, #2_100
			TST     R1, R2							;ANDS de R1 com R2
            BEQ     EsperaTIMER					    ;Se o flag Z=1, volta para o laço. Senão continua executando
