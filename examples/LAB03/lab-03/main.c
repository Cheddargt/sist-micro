...
void DisplayInit (void)
{
		...
		PortM_Output(0);			//ATIVA A ENTRADA DE INTSTRUCOES
		SysTick_Wait1us(40);
													//iniciando o cursor (habilitar o display + cursor + n�o-pisca)
	  PortM_Output(4);			//ATIVA A ENTRADA DE INTSTRUCOES
		PortK_Output(0x0E);
		SysTick_Wait1us(10);
	  PortM_Output(0);
...
void DisplayEscreve (char *mensagem)
{
		...
		for(i=0;mensagem[i];i++)
		{
			...
			{
				PortM_Output(4);			//ATIVA A ENTRADA DE INTSTRUCOES
				PortK_Output(0xC0);		//intru��o para limpar
				SysTick_Wait1us(40);
				PortM_Output(0);			//ATIVA A ENTRADA DE INTSTRUCOES
				SysTick_Wait1us(1640);
			}
...
{
		PortM_Output(4);			//ATIVA A ENTRADA DE INTSTRUCOES
		PortK_Output(0xCE);		//intru��o para limpar
		SysTick_Wait1us(40);
		PortM_Output(0);			//ATIVA A ENTRADA DE INTSTRUCOES
		SysTick_Wait1us(1640);
}
...
{
		PortM_Output(4);			//ATIVA A ENTRADA DE INTSTRUCOES
		PortK_Output(0x1);		//intru��o para limpar
		SysTick_Wait1us(40);
		PortM_Output(0);			//ATIVA A ENTRADA DE INTSTRUCOES
		SysTick_Wait1us(1640);
}	
